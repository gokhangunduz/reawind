...
export default function PageHeader({
  ...
  return (
    <div className="flex flex-col gap-4 justify-center items-center h-64 text-layer-dark-900 dark:text-layer-light-50 select-none transition-all duration-500">
